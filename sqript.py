...
def tak ():
 ...
 time.sleep(0.3)
 os.system('clear')
 print('\n\t\033[0;32mwelkom to my sqript 2021')
 time.sleep(0.5)
 print('\033[0;31mloading..')
 time.sleep(1)
 print('\033[0;33mcomplet\n')
 print('\033[0;36m        ──▒▒▒▒▒▒▒▒─watsap:──▒▒▒▒▒▒▒▒ ─▒▐▒▐▒▒▒▒▌▒─▒▒▌▒▒▐▒▒▌▒ ──▒▀▄█▒▄▀▒───▒▀▄▒▌▄▀▒ ─────██─0691847398───~────██ ░░░▄▄██▄░░░░░░░▄██▄░░░ \n')
...
def mat():
 ...
 for x in range (10) :
   ...
   print('loading..............................')
 os.system('clear')
 print('\t\033[0;92mloading.........')
 os.system('clear')
 time.sleep(0.5)
 print('\t\_____hello to math ____/\n')
 time.sleep(0.5)
 print('\033[0;33m\t ──▒▒▒▒▒▒▒▒───▒▒▒▒▒▒▒▒ ─▒▐▒▐▒▒▒▒▌▒─▒▒▌▒▒▐▒▒▌▒ ──▒▀▄█▒▄▀▒───▒▀▄▒▌▄▀▒ ─────██──Math───────██ ░░░▄▄██▄░░░░░░░▄██▄░░░')
 time.sleep(0.5)
 print('\t\033[0;91m[AB] _ [AC] _ [BC] _ ? ?\n')
 while True :
  a=int(input('\033[0;96mEnter [AB]:'))
  b=int(input('\033[0;95mEnter [AC]:'))
  if a== (0) or b==(0):
    tak()
